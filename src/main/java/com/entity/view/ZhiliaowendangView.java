...
public class ZhiliaowendangView extends ZhiliaowendangEntity implements Serializable {
	...
	public ZhiliaowendangView() {

	}

	public ZhiliaowendangView(ZhiliaowendangEntity zhiliaowendangEntity) {
		try {
			BeanUtils.copyProperties(this, zhiliaowendangEntity);
