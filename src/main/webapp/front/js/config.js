...
var centerMenu = [
    ...
    ,{
        name: '面试通知收藏',
        url: '../mianshitongzhiCollection/list.jsp'
    }
    ,{
        name: '学习资源收藏',
        url: '../xuexizhiyuanCollection/list.jsp'
    }
    ,{
        name: '资料文档收藏',
        url: '../zhiliaowendangCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '面试通知',
        url: './pages/mianshitongzhi/list.jsp'
    },
    {
        name: '学习资源',
        url: './pages/xuexizhiyuan/list.jsp'
    },
    {
        name: '资料文档',
        url: './pages/zhiliaowendang/list.jsp'
    },
    {
        name: '新闻',
...
var adminurl =  "http://localhost:8080/zhiyuangongxiangpingtai/index.jsp";
