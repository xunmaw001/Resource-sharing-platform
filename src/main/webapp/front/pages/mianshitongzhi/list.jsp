                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../mianshitongzhi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../mianshitongzhi/detail.jsp?id='+item.id)"><span>{{item.mianshitongzhiName}}</span></div>
        ...
        function pageList() {
            ...
            if (jquery('#mianshitongzhiName').val() != null && jquery('#mianshitongzhiName').val() != "" && jquery('#mianshitongzhiName').val() != "null" ) {
                param['mianshitongzhiName'] = jquery('#mianshitongzhiName').val();
                                            ...
                                            // 获取列表数据
            http.request('mianshitongzhi/list', 'get', param, function(res) {
