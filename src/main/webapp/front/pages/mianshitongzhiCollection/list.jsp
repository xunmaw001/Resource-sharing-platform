            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">面试通知收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="mianshitongzhiName" id="mianshitongzhiName" placeholder="公司名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../mianshitongzhi/detail.jsp?id='+item.mianshitongzhiId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.mianshitongzhiPhoto?item.mianshitongzhiPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../mianshitongzhi/detail.jsp?id='+item.mianshitongzhiId)"><span>{{item.mianshitongzhiName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.mianshitongzhiNewMoney"><span style="color: red;">{{item.mianshitongzhiNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#mianshitongzhiName').val() != null && jquery('#mianshitongzhiName').val() != "" && jquery('#mianshitongzhiName').val() != "null" ) {
                param['mianshitongzhiName'] = jquery('#mianshitongzhiName').val();
            }
                                                                                                                                
            // 当前表
                                // 获取列表数据
            http.request('mianshitongzhiCollection/list', 'get', param, function(res) {
