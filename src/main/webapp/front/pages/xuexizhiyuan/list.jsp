                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../xuexizhiyuan/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../xuexizhiyuan/detail.jsp?id='+item.id)"><span>{{item.xuexizhiyuanName}}</span></div>
        ...
        function pageList() {
            ...
            if (xuexizhiyuanTypes != null && xuexizhiyuanTypes != "" && xuexizhiyuanTypes != "null") {
                param['xuexizhiyuanTypes'] = xuexizhiyuanTypes;
                        ...
                        // 获取列表数据
            http.request('xuexizhiyuan/list', 'get', param, function(res) {
