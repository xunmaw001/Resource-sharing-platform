            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">学习资源收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xuexizhiyuanName" id="xuexizhiyuanName" placeholder="资源名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="xuexizhiyuanTypes" id="xuexizhiyuanTypes" lay-filter="xuexizhiyuanTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in xuexizhiyuanTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../xuexizhiyuan/detail.jsp?id='+item.xuexizhiyuanId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.xuexizhiyuanPhoto?item.xuexizhiyuanPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../xuexizhiyuan/detail.jsp?id='+item.xuexizhiyuanId)"><span>{{item.xuexizhiyuanName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.xuexizhiyuanNewMoney"><span style="color: red;">{{item.xuexizhiyuanNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#xuexizhiyuanName').val() != null && jquery('#xuexizhiyuanName').val() != "" && jquery('#xuexizhiyuanName').val() != "null" ) {
                param['xuexizhiyuanName'] = jquery('#xuexizhiyuanName').val();
            }
                                                 
            var xuexizhiyuanTypes = $("#xuexizhiyuanTypes").find("option:selected").val();
            if (xuexizhiyuanTypes != null && xuexizhiyuanTypes != "" && xuexizhiyuanTypes != "null") {
                            param['xuexizhiyuanTypes'] = xuexizhiyuanTypes;
                        }
                                                
            // 当前表
                                // 获取列表数据
            http.request('xuexizhiyuanCollection/list', 'get', param, function(res) {
...
// 级联表的字典表
       ...
       function xuexizhiyuanTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuexizhiyuan_types", 'get', {}, function (res) {
               if(res.code == 0){
                   vue.xuexizhiyuanTypesList = res.data.list;
               }
           });
       }
