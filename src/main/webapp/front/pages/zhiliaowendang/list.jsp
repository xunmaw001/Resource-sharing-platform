                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../zhiliaowendang/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../zhiliaowendang/detail.jsp?id='+item.id)"><span>{{item.zhiliaowendangName}}</span></div>
        ...
        function pageList() {
            ...
            if (jquery('#zhiliaowendangName').val() != null && jquery('#zhiliaowendangName').val() != "" && jquery('#zhiliaowendangName').val() != "null" ) {
                param['zhiliaowendangName'] = jquery('#zhiliaowendangName').val();
                                    ...
                                    // 获取列表数据
            http.request('zhiliaowendang/list', 'get', param, function(res) {
