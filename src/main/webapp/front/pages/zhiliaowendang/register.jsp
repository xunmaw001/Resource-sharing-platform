              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">文档名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiliaowendangName" id="zhiliaowendangName"  placeholder="文档名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">文档大小:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhiliaowendangDaxiao" id="zhiliaowendangDaxiao"  placeholder="文档大小"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
