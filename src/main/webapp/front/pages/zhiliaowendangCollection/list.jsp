            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">资料文档收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhiliaowendangName" id="zhiliaowendangName" placeholder="文档名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../zhiliaowendang/detail.jsp?id='+item.zhiliaowendangId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.zhiliaowendangPhoto?item.zhiliaowendangPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../zhiliaowendang/detail.jsp?id='+item.zhiliaowendangId)"><span>{{item.zhiliaowendangName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.zhiliaowendangNewMoney"><span style="color: red;">{{item.zhiliaowendangNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#zhiliaowendangName').val() != null && jquery('#zhiliaowendangName').val() != "" && jquery('#zhiliaowendangName').val() != "null" ) {
                param['zhiliaowendangName'] = jquery('#zhiliaowendangName').val();
            }
                                                                                                
            // 当前表
                                // 获取列表数据
            http.request('zhiliaowendangCollection/list', 'get', param, function(res) {
