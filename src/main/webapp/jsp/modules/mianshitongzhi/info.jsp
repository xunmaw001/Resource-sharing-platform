            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">面试通知登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="mianshitongzhiName" name="mianshitongzhiName" class="form-control"
                                               v-model="ruleForm.mianshitongzhiName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="mianshitongzhiZhiwei" name="mianshitongzhiZhiwei" class="form-control"
                                               v-model="ruleForm.mianshitongzhiZhiwei" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>公司图片</label>
                                    <img id="mianshitongzhiPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>公司待遇</label>
                                        <input id="mianshitongzhiDaiyu" name="mianshitongzhiDaiyu" class="form-control"
                                               v-model="ruleForm.mianshitongzhiDaiyu" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="mianshitongzhiYuexin" name="mianshitongzhiYuexin" class="form-control"
                                               v-model="ruleForm.mianshitongzhiYuexin" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="mianshitongzhiDizhi" name="mianshitongzhiDizhi" class="form-control"
                                               v-model="ruleForm.mianshitongzhiDizhi" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "mianshitongzhi/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.mianshitongzhiContent != null && ruleForm.mianshitongzhiContent != 'null' && ruleForm.mianshitongzhiContent != '') {
            var mianshitongzhiContentUeditor = UE.getEditor('mianshitongzhiContentEditor');
                mianshitongzhiContentUeditor.ready(function () {
                    ...
                    mianshitongzhiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
